...
export default function SelectAvatar() {
    const avatars = useMemo(() => randomizeAvatars([...Object.values(avatars_)]).slice(0, 8), []);    
    ...
    return (
      <div className="flex items-center bg-one dev justify-center min-h-screen">
        <div className="w-full max-w-5xl bg-white rounded-xl overflow-hidden flex flex-col min-h-[600px]  justify-center items-center">
          {selectedAvatar ? (
            <div className="flex flex-col items-center justify-center h-4/6">
              ...
              />
              <button className="px-36 py-2 bg-[#47227f] text-white font-bold rounded-lg ">
                Upload
              </button>
            </div>
          ) : (
